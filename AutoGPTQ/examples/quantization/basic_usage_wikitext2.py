...
def main(args):
    tokenizer = AutoTokenizer.from_pretrained(args.pretrained_model_dir, use_fast=True)
    traindataset,testenc = get_wikitext2(128, 0, 2048, args.pretrained_model_dir)
